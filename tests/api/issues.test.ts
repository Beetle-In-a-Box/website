...
describe('Issues API', () => {
    ...
    describe('POST /api/issues', () => {
        ...
        it('should create a new issue with image', async () => {
            ...
            formData.append(
                'image',
                new File(['fake image'], 'cover.jpg', { type: 'image/jpeg' }),
            )
            ...
            expect(data.imageUrl).toBe('/images/test-image.jpg')
        })
        ...
        it('should return 400 if image validation fails', async () => {
            ...
            formData.append(
                'image',
                new File(['fake large image'], 'large.jpg', {
                    type: 'image/jpeg',
                }),
            )
    ...
    describe('GET /api/issues', () => {
        ...
        it('should filter by published status', async () => {
            ...
            const request = new NextRequest(
                'http://localhost:3000/api/issues?published=true',
            )
    ...
    describe('PUT /api/issues/[id]', () => {
        ...
        it('should update issue with new image', async () => {
            ...
            formData.append(
                'image',
                new File(['new image'], 'new-cover.jpg', {
                    type: 'image/jpeg',
                }),
            )
